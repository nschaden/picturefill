...
(function(w,doc) {
    ...
    w.picturefill = function(forceEvaluate) {
        ...
        for (var i=0, plen = pictures.length; i < plen; i++) {
            ...
            w.picturefill.resolvePicture(picture,forceEvaluate);
        }
    ...
    w.picturefill.resolvePicture = function(picture,forceEvaluate) {
    ...
    /**
     * forces Picturefill to resolve the last picture present in the DOM
     */
    w.picturefill.resolveLast = function() {
        ...
        for (var i = pictures.length - 1; i >= 0; i--) {
            if (pictures[ i ].getAttribute('data-picture-evaluated') === null && pictures[ i ].getAttribute('data-defer') === null) {
                w.picturefill.resolvePicture(pictures[ i ]);
                break;
            }
        }
    };
